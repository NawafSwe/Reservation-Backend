...
const validate = (req: Request, res: Response, next: NextFunction) => {
    try {
        const schema = Joi.object({
            ...
            startingWorkingHoursDate: Joi.string().required(),
            endingWorkingHoursDate: Joi.string().required(),
        });
        ...
        console.error(`error occurred at createRestaurant validation, error: ${error}`);
