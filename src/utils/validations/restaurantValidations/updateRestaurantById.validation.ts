...
const validate = (req: Request, res: Response, next: NextFunction) => {
    try {
        const schema = Joi.object({
            ...
            startingWorkingHoursDate: Joi.string().optional(),
            endingWorkingHoursDate: Joi.string().optional(),
        });
        ...
        console.error(`error occurred at updateRestaurantById validation, error: ${error}`);
